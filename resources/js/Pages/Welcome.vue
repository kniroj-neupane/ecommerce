                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                ...
                                <ApplicationLogo class="block h-20 w-auto fill-current mt-4" />
                                </Link>
                            </div>
                        </div>
                        <!-- sign up and log in  -->
                        ...
                        <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }"
                            class="sm:hidden">
                            <div class="pt-2 pb-3 space-y-1 bg-teal-600">
                                <ResponsiveNavLink :href="route('register')" class="text-gray-100">
                                    Register
                                </ResponsiveNavLink>
                                <ResponsiveNavLink :href="route('login')" class="text-gray-100">
                                    Login
                                </ResponsiveNavLink>
                            </div>
